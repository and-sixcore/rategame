...
export const sections: Section[] = [
  ...
  // -------------------------------------------------------------- Articles --
  { id: "article-card", name: "Article Card", category: "Articles", complexity: "composite", source: "both", status: "built", flowId: "articles-grid",
    description: "Editorial article preview: cover (image or gradient), kicker, title, byline, like / comment counts. Built deliberately distinct from the Did You Know card, with no overlaid chips, no vignette, and the text below the media.",
    variants: ["grid (Var A)", "feed (Var B)"],
    refs: { web: "components/articles/ArticleFeedCard.tsx", mobile: "src/views/Community/Articles/components/ArticleFeedCard.tsx" } },
  { id: "article-read-view", name: "Article Read View", category: "Articles", complexity: "advanced", source: "both", status: "built", flowId: "articles-grid",
    description: "The article reading screen: cover, kicker, title, byline, body, and like / comment actions. The end of the Articles flow.",
    refs: { web: "components/articles/ArticleFeedCard.tsx" } },
  { id: "article-cover", name: "Article Cover", category: "Articles", complexity: "atomic", source: "both", status: "built", flowId: "articles-grid",
    description: "Article cover media: the real image when present, otherwise an on-brand monochrome gradient fallback that stays inside the system (no semaphore).",
    variants: ["image", "gradient fallback"] },
  { id: "article-byline", name: "Article Byline", category: "Articles", complexity: "atomic", source: "both", status: "built", flowId: "articles-grid",
    description: "Author line for articles: avatar, author, date, read time; pairs with the like / comment counts." },
  ...
  // ---------------------------------------------------------------- Common --
  { id: "button", name: "Button", category: "Common", complexity: "atomic", source: "both", status: "built",
  ...
  { id: "chip", name: "Chip / Tag", category: "Common", complexity: "atomic", source: "both", status: "built",
  ...
  { id: "score-pill", name: "Score Pill", category: "Common", complexity: "atomic", source: "both", status: "built",
  ...
  { id: "badge", name: "Badge", category: "Common", complexity: "atomic", source: "both", status: "built",
  ...
  { id: "avatar", name: "Avatar", category: "Common", complexity: "atomic", source: "both", status: "built",
  ...
  { id: "rating-slider", name: "Rating Slider", category: "Common", complexity: "atomic", source: "both", status: "built",
    description: "Interactive 0–10 range slider for rating input.",
    refs: { web: "components/ui/slider.tsx" } },
  { id: "tabs", name: "Tabs / Segmented", category: "Common", complexity: "atomic", source: "both", status: "built",
